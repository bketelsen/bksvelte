...
<div class="relative bg-indigo-800">
	<div class="absolute inset-0">
		<img
			...
			src="https://images.unsplash.com/photo-1525130413817-d45c1d127c42?ixlib=rb-1.2.1&ixqx=xOj3C4oXs9&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=60&&sat=-100"
			alt=""
		/>
		<div
			class="absolute inset-0 bg-indigo-800"
